    ...
    public class Assembler
    {
        ...
        private static IOperand DecodeOperand(string operand)
        {
            return operand switch
            {
                ...
                "c" => new RegisterOperand(Register.C), // Is also condition carry
                ...
                "nz" => new ConditionOperand(Condition.NZ),
                "nc" => new ConditionOperand(Condition.NC),
                "po" => new ConditionOperand(Condition.PO),
                "p" => new ConditionOperand(Condition.P),
                "z" => new ConditionOperand(Condition.Z),
                "pe" => new ConditionOperand(Condition.PE),
                "m" => new ConditionOperand(Condition.M),
                ...
                _ when IsAddress(operand) => new AddressOperand(ParseNumber(operand.Split(new char[] {'(', ')' })[1])),
